...
//On récupère tous les fronts
        public function prez_front_creation(){
			...
			<a href="editeur.php?selected=<?php print $_SESSION['front'] ?>&selected2=<?php print $_SESSION['yeux'] ?>&selected3=<?php print $_SESSION['nez'] ?>&selected4=<?php print $_SESSION['bouche_buste'] ?>" class="selecteur" name="<?php print $id_front ?>"><div id="front"><img id='<?php print $id_front ?>' class="selecteur"  src="http://romaneh.marmier.codeur.online/generateur-avatar/Views/Images/<?php print $row['front']; ?>"><br></div></a>
            <?php
            ; }
        }
        ...
        public function get_front_creation($pdo){
            ...
            if($front_select == ""){
                ...
                foreach($this->db->query($front_crea) as $row){?>
                    <img src="http://romaneh.marmier.codeur.online/generateur-avatar/Views/Images/<?php print $row['front']; ?>" alt="">
        ...
        public function get_yeux_creation($pdo){
            ...
            if($yeux_select == ""){
                ...
                foreach($this->db->query($yeux_crea) as $row){?>
                    <img src="http://romaneh.marmier.codeur.online/generateur-avatar/Views/Images/<?php print $row['yeux']; ?>" alt="">
                <?php
                }
            }
            else{
        ...
        public function get_nez_creation($pdo){
            ...
            if($nez_select == ""){
                ...
                foreach($this->db->query($nez_crea) as $row){?>
                    <img src="http://romaneh.marmier.codeur.online/generateur-avatar/Views/Images/<?php print $row['nez']; ?>" alt="">
                <?php
                }
            }
            else{
        ...
        public function get_bouche_buste_creation($pdo){
            ...
            if($bouche_buste_select == ""){
                ...
                foreach($this->db->query($bouche_buste_crea) as $row){?>
                    <img src="http://romaneh.marmier.codeur.online/generateur-avatar/Views/Images/<?php print $row['bouche_buste']; ?>" alt="">
                <?php
                }
            }
            else{
