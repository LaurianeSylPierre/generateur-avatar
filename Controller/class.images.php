...
//On récupère tous les fronts
        public function prez_front_creation(){
			...
			<a href="editeur.php?selected=<?php print $id_front ?>" name="<?php print $id_front ?>"><div id="front"><img id='<?php print $id_front ?>' src="http://eddyr.marmier.codeur.online/generateur-avatar/Views/Images/<?php print $row['front']; ?>"><br></div></a>
            <?php
            ; }
        }
        ...
        public function prez_yeux_creation(){
            ...
            foreach($this->db->query($yeux_all) as $row){
                ...
                ?>
                <a href="editeur.php?selected=<?php print $id_yeux ?>" name="<?php print $id_yeux ?>"><div id='yeux'><img id='<?php print $id_yeux?>' src='http://eddyr.marmier.codeur.online/generateur-avatar/Views/Images/<?php print $row['yeux'];?>'><br></div></a>
            <?php
            ; }
        }
        ...
        public function prez_nez_creation(){
            ...
            foreach($this->db->query($nez_all) as $row){
                $id_nez = $row['id_image'];
                ?>
                <a href="editeur.php?selected=<?php print $id_nez ?>" name="<?php print $id_nez ?>"><div id='nez'><img id='<?php print $id_nez?>' src='http://eddyr.marmier.codeur.online/generateur-avatar/Views/Images/<?php print $row['nez'];?>'><br></div></a>
            <?php
            ; }
        }
        ...
        public function prez_bouche_buste_creation(){
            ...
            foreach($this->db->query($bouche_buste_all) as $row){
                ...
                <a href="editeur.php?selected=<?php print $id_bouche_buste ?>" name="<?php print $id_bouche_buste ?>"><div id='bouche_buste'><img id='<?php print $id_bouche_buste ?>' src='http://eddyr.marmier.codeur.online/generateur-avatar/Views/Images/<?php print $row['bouche_buste'];?>'><br></div></a>
            <?php
            ; }
        }
...
//Récupère le front pour le mettre sur l'avatar lors de la création
        public function get_front_creation($pdo){
            ...
            if($front_select = ""){
                ...
                foreach($pdo->query($front_crea) as $row){
...
//Récupère les yeux pour les mettre sur l'avatar lors de la création
        public function get_yeux_creation($pdo){
            ...
            if($yeux_select = ""){
                ...
                foreach($pdo->query($yeux_crea) as $row){
                    print $row['yeux'];
                }
            }
            else{
...
//Récupère le nez pour le mettre sur l'avatar lors de la création
        public function get_nez_creation($pdo){
            ...
            if($nez_select = ""){
                ...
                foreach($pdo->query($nez) as $row){
                    print $row['nez'];
                }
            }
            else{
                $nez_crea = "SELECT nez FROM Banque_images WHERE nez = '$nez_select'";
                foreach($pdo->query($nez_crea) as $row){
                    print $row['nez'];
                }
            }
        }
